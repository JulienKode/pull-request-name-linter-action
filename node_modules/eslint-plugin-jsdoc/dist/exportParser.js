...
const findNode = function findNode(node, block, cache) {
  ...
  const _block$props = block.props,
        props = _block$props === void 0 ? block.body : _block$props;

  for (var _i = 0, _Object$values = Object.values(props || {}); _i < _Object$values.length; _i++) {
    const propval = _Object$values[_i];
...
const findExportedNode = function findExportedNode(block, node, cache) {
  ...
  for (var _i2 = 0, _Object$values2 = Object.values(props); _i2 < _Object$values2.length; _i2++) {
    const propval = _Object$values2[_i2];
